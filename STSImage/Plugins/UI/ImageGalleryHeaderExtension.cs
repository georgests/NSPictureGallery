...
{
	public class ImageGalleryHeaderExtension : IPlugin, ITranslatablePlugin, IHtmlHeaderExtension, IHttpCallback
	{
		...
		public string Name
		{
			get { return "ImageGallery Header Extension"; }
		}

		public string Description
		{
			get { return "Registers scripts to support rendering ImageGallery."; }
		}
		...
		public Translation[] DefaultTranslations
		{
			get 
			{
				...
				translation.Set("sts_image_delete", "Delete your image.");
                /*
				translation.Set("sts_image", "You voted for '{AnswerName}' {Date}.");
		...
		public void ProcessRequest(System.Web.HttpContextBase httpContext)
		{
			...
			{
				file = "Widgets.ImageGallery.ui.js";
			...
			httpContext.Response.Write(InternalApi.EmbeddedResources.GetString("STSImage.Resources." + file));
		}
...
(function($){{
	$.telligent.evolution.ui.components.poll.configure({{deleteMessage:'{2}'}});
}}(jQuery));
</script>
",
				_callbackController.GetUrl(jsQuery),
				_callbackController.GetUrl(cssQuery),
                TEApi.Javascript.Encode(_translation.GetLanguageResourceValue("sts_image_delete")) //,
                /*
